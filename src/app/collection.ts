...
export const nameCollection: Collection<string> = new Collection<string>(['Adam', 'Aziz', 'John']);
export const numberCollection: Collection<number> = new Collection<number>([350, 400, 450]);